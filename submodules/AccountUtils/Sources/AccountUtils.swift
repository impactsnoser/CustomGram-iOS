...
public var maximumNumberOfAccounts: Int {
    CustomGramFeatureGates.maximumNumberOfAccounts
}

public var maximumPremiumNumberOfAccounts: Int {
    CustomGramFeatureGates.maximumPremiumNumberOfAccounts
}
