...
private var declaredEncodables: Void = {
    ...
    declareEncodable(CustomGramDeletedMessageAttribute.self, f: { CustomGramDeletedMessageAttribute(decoder: $0) })
    declareEncodable(CustomGramEditedMessageAttribute.self, f: { CustomGramEditedMessageAttribute(decoder: $0) })
    return
}()
